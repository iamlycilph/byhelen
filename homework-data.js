...
//   why  — короткое объяснение по-русски, почему так;
//   keys — слова-подсказки в предложении, подсвечиваются после ответа.
// Порядок заданий сохранён как на листе — чтобы сверять с Еленой по номерам.
